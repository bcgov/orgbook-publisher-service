...
The credential type registration is the most complex and critical component, enabling issuers to publish their data as Verifiable Credentials via the UNTP Publisher to the configured registry.
